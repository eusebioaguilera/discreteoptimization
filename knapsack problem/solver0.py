...
"""
    ...
    algorithm. This program may use a big amount of memory.
...
def solveIt(inputData):
    ...
    while True:
        ...
        if node.level == items:
            # Feasible solution
            if node.value > optimal_node.value:
                optimal_node = node
        ...
        if father.father == None and len( father.children ) == 2:
            break
